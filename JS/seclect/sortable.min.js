"use strict";
var _extends=Object.assign||function(t){for(var e=1;e<arguments.length;e++){
	var n=arguments[e];
	for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(t[i]=n[i])}return t},
		_createClass=function(){function i(t,e){for(var n=0;n<e.length;n++){
...
function _toConsumableArray(t){
	...
	return Array.from(t)}function _classCallCheck(t,e){
		if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")
	}
var Sortable=function(){function d(){
	var t=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},
	e=t.parent,n=t.links,i=void 0===n?document.querySelectorAll("[data-sjslink]"):n,
	s=t.active,
	...
	return _createClass(d,[{key:"orderelements",
		value:function(){
			var r=this,
			t=this.parent,
	...
	value:function(t,e){var n=this;
		...
		e.dataset.sjslink!==this.dataLink&&(this.dataLink=e.dataset.sjslink,
			i.forEach(function(t){t.isEqualNode(e)?t.classList.add(s):t.classList.remove(s)}),
			this._filterElements(function(){n.orderelements()
			}))
	}
},
{key:"resize",
...
{key:"init",value:function(){
	...
	e=this.links,
	i=this.active;
	e.forEach(function(e,t){0===t&&(e.classList.add(i),n.dataLink=e.dataset.sjslink),
...
value:function(t,s){
	return t.reduce(function(t,e,n){
		var i=n%s;return t[i]||(t[i]=0),t[i]=t[i]+e,t},
		[])
}
},
{key:"_columnsCount",
value:function(t){
	...
	return Object.entries(t).reduce(function(t,e){
		return n>e[0]&&e[0]>=Math.max(t.width)?{width:e[0],columns:e[1].columns}:t},
		{
			width:0,columns:4
		})
}
},
{key:"_fadeIn",value:function(e){
	var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:300,
	n=arguments[2],i=parseFloat(window.getComputedStyle(e,null).getPropertyValue("opacity")),
	s=16/t;
	...
	value:function(e){
		...
		s=t?16/t:1;requestAnimationFrame(function t(){0<=(i-=s)?(e.style.opacity=i,
	...
	HTMLElement.prototype.sortablejs=HTMLElement.prototype.sortablejs||function(t){
		return new Sortable(_extends({parent:this},t)
			)
	};